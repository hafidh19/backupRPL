        ...
        <form class="" action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="hbarang" min = "1" class="form-control has-feedback{{ $errors->has('hbarang') ? ' is-invalid' : '' }}"  value="{{ old('hbarang') }}" required autofocus>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="jbarang" min = "1" class="form-control{{ $errors->has('jbarang') ? ' is-invalid' : '' }}"  value="{{ old('jbarang') }}" required autofocus>
                    <div class="col-md-6">
